...
void main_window_load(Window *window) {
  ...
  // Date Text
  DateText = text_layer_create(GRect(0, 38, 140, 46));
  ...
  layer_add_child(window_get_root_layer(window), text_layer_get_layer(DateText));
    ...
    // Day Text
  DayText = text_layer_create(GRect(0, 71, 140, 26));
  ...
  layer_add_child(window_get_root_layer(window), text_layer_get_layer(DayText));
    ...
    // Line Text
  LineText = text_layer_create(GRect(0, 81, 14, 14));
  ...
  layer_add_child(window_get_root_layer(window), text_layer_get_layer(LineText));
    ...
    // Line Text 2
  LineText2 = text_layer_create(GRect(0, 82, 14, 14));
  ...
  // Time Text
  TimeText = text_layer_create(GRect(0, 100, 140, 64));
